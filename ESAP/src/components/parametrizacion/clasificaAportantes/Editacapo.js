...
class Editacapo extends Component {
    ...
    guardar = (e) =>{
        ...
        actualiza(tabe, "clasificacionesaportantes", "Clasificación aportantes", this.idc);
