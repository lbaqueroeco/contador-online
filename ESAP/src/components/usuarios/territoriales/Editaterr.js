...
class Editaterr extends Component {
    ...
    guardar = (e) =>{
        ...
        actualiza(tabe1, "territoriales", "Territorial", this.idc);
    ...
    render() {
        ...
        return (
            <div>
                ...
                <Script2 id={this.props.match.params.id} tabla="territoriales" devuelvedatos={this.dato} />
                        ...
                        <div className="card pd-20 pd-sm-40">
                            ...
                            <form  name="forma" onSubmit={this.guardar}>
                                <div className="modal-content tx-size-sm">
                                    ...
                                    <Pais valor={this.state.idpaises}/>
                                    ...
                                    <Fila nombre="Macrozona" refer="Macro" tipo="1" arreglo="" defecto={this.state.ter_macrozona} />
                                </div>
