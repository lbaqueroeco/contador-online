    ...
    render() {
        ...
        return (
            <div className={ancho} >
                ...
                {
                    tipo === "1"? (
                        <input name={refer} ref={refer} defaultValue={defecto} placeholder={nombre} className="form-control" required type="text" />
                    ) :
                    tipo === "2"? (
                        <input name={refer} ref={refer} defaultValue={defecto} placeholder={nombre} className="form-control" required type="number" />
                    ) :
                    tipo === "3"? (
                        <input name={refer} ref={refer} defaultValue={defecto} placeholder={nombre} className="form-control" required type="email" />
                    ) :
                    tipo === "4"? (
                        <input name={refer} ref={refer} className="form-control" placeholder={nombre} required type="password" />
                    ) :
                    tipo === "5"? (
                    ...
                    tipo === "7"? (
                        <input name={refer} ref={refer} defaultValue={defecto} className="form-control" required type="date" />
                    ) :
                    tipo === "8"? (
                    ...
                    (
                        <input name={refer} ref={refer} defaultValue={defecto} className="form-control" required type="number" />
                    ) 
                }
            </div>
)
